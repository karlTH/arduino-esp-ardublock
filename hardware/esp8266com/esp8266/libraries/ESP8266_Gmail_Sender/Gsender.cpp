...
void Gsender::SMTP_PORT2(int Port)
{
	SMTP_PORT=Port;
}
void Gsender::SMTP_SERVER2(char* Server)
{
	SMTP_SERVER=Server;
}
void Gsender::EMAILBASE64_LOGIN2(char* LOGIN)
{
	EMAILBASE64_LOGIN=LOGIN;
}
void Gsender::EMAILBASE64_PASSWORD2(char* PASSWORD)
{
